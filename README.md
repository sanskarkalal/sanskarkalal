...
I’m currently a **Mobile App Development Intern** at Ampcus Tech Pvt. Ltd., where I’m:  
- Building a cross-platform React Native prototype using Expo and Firebase Realtime Database.  
- Developing an ETA algorithm using live queue data for a pilot barbershop system (scaling to 5+ locations).  
- Implementing Redux for state management and React Navigation for intuitive user flows.  

As a former **Teaching Assistant** at UIC, I helped over 250 students strengthen their C++ and Python skills through workshops and labs.  

When I’m not coding, I create engaging content for 100K+ followers across Instagram and YouTube, with collaborations for brands like **Spotify** and **Premier League**.  
